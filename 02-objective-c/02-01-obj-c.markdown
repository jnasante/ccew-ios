...
You can always unpack these statements and create local variable to hold each separate object-method pair, but once you grow accustom to it, it is idiomatic to write code this way.
